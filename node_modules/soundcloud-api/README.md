...
A Node.js Soundcloud api wrapper.<br>
Check out the HTTP API at https://developers.soundcloud.com/docs/api/reference.
...
####Bugs
If there are any problems, feel free to report!

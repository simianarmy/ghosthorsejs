...
GhostHorse.prototype.init = function () {
    ...
    self.uploader = self.createAudioUploader();
...
GhostHorse.prototype.saveTweet = function (tweet) {
    ...
    // nothing
    this.dataStore.saveHorseTweet(this.getHandleAccountId(tweet.handle), tweet)
        .then(function () {
            return self.uploader.upload(tweet);
        })
        .then(function () {
        ...
        .then(null, function (err) {
            if (err !== 'already exists') {
                // FIXME: This fucks everything up!

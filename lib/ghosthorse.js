...
var http = require('http'),
    ...
    Sprinkler = require('lib/twhisprersprinkler');
...
GhostHorse.prototype.createSprinkler = function (client) {
    this._sprinkler = new Sprinkler({client: client});
...
GhostHorse.prototype.saveTweet = function (tweet) {
    ...
    this.uploader.upload(tweet)
        ...
        .then(null, function (err) {
            console.log('OH NOES!  Failed saving tweet or audio: ' + err);
        });
};

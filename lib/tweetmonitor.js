...
TweetMonitor.prototype.start = function () {
    ...
    console.log('begin tracking twitter user ' + this._user);
...
TweetMonitor.prototype._search = function (opts) {
    ...
    console.log('searching twitter for ' + this._user, opts);
...
TweetMonitor.prototype._getMaxTweetId = function () {
    return Math.max.apply(null, Object.keys(this._saved));
};
